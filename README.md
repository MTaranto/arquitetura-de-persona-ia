# 🧠 Arquitetura de Persona IA: Engenharia de Contexto e System Prompting Aplicado

Olá, sou o **Márcio Taranto**. Se você chegou até aqui, saiba que este não é mais um repositório de tutoriais genéricos. Este é o meu laboratório prático de **Orquestração de Inteligência Artificial e Análise Funcional**. 

Com uma carreira ancorada em mais de 20 anos de vivência no setor comercial e logístico, incluindo a gestão de operações críticas no controle de tráfego ferroviário, aprendi a enxergar sistemas de forma pragmática: a tecnologia só tem valor se resolver o caos do mundo real. Hoje, como Analista de Sistemas e estudante de Engenharia de Software, meu foco absoluto é extrair a máxima eficiência do desenvolvimento assistido por IA.

## 🎯 O Estudo de Caso: O Projeto Gaia

A "Gaia" não é um script de chatbot comum. Ela é o resultado de uma arquitetura meticulosa de *System Prompting* e calibração de contexto, projetada para atuar como uma parceira intelectual e de *brainstorming*. 
